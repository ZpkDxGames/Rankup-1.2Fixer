...
public class RankManager {
    ...
    public Rank getRank(int id) { return ranks.get(id); }
    public Rank getNextRank(int currentId) { return getRank(currentId + 1); }
    public FileConfiguration getRanksConfig() { return ranksConfig; }
    public TreeMap<Integer, Rank> getRanks() { return ranks; }
